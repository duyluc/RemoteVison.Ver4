...
namespace TcpSupport
{
    public class TcpBase
    {
        ...
        public class TcpReceiveArgs : EventArgs
        {
            public long TaktTime { get; set; }
            public Socket TcpSocket { get; set; }
            public TcpReceiveArgs(Socket tcpsocket, long takttime)
            {
                this.TcpSocket = tcpsocket;
                this.TaktTime = takttime;
            }
        ...
        public void OnSended(Socket tcpSocket,long takttime)
        {
            Sended?.Invoke(this, new TcpSendArgs(tcpSocket,takttime));
        }
        public void OnReceived(Socket tcpSocket, long takttime)
        {
            Received?.Invoke(this, new TcpSendArgs(tcpSocket, takttime));
        }
        public void OnSendTimeouted()
        {
            SendTimeouted?.Invoke(this, EventArgs.Empty);
        }
        public void OnReceiveTimeouted()
        {
