...
public class _TerminalCollection : IDictionary
{
    // The array of items
    private DictionaryEntry[] items;
    private Int32 ItemsInUse = 0;

    public _TerminalCollection(Int32 numItems)
    {
    ...
    private class _TerminalCollectionEnumerator : IDictionaryEnumerator
    {
        // A copy of the SimpleDictionary object's key/value pairs.
        DictionaryEntry[] items;
        Int32 index = -1;

        public _TerminalCollectionEnumerator(_TerminalCollection sd)
        {
    ...
    public IDictionaryEnumerator GetEnumerator()
    {
        ...
        return new _TerminalCollectionEnumerator(this);
    }
    #endregion
